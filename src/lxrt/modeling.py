...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, word_embeddings=None):
...
class LXRTModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
                visual_feats=None, visual_attention_mask=None, precomputed_word_embeddings=None):
        ...
        embedding_output = self.embeddings(input_ids, token_type_ids, word_embeddings=precomputed_word_embeddings)
...
class LXRTFeatureExtraction(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, visual_feats=None,
                visual_attention_mask=None, precomputed_word_embeddings=None):
